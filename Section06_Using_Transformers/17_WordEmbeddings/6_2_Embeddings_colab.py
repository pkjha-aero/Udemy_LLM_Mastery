...
sentence3 = "To become a commercial pilot, he had to fly for 1500 hours." # second fly example
...
encoded_inputs = tokenizer(sentence1, return_tensors="pt")

encoded_inputs

model(**encoded_inputs).last_hidden_state
...
#out3[0:, tokens1.index("fly"), :].detach()[0]
